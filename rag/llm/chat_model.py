...
if __name__ == '__main__':
    ...
    print(SILICONFLOWChat(key=key, model_name=model_name).chat(system="You are a helpful assistant.", history=[{"role": "user", "content": "你是鸡巴谁啊!"}], gen_conf={"temperature": 0.7, "max_tokens": 1000}))
