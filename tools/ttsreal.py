...
class BaseTTS:
    def __init__(self, opt, parent):
        ...
        self._rcg = Funasr_websocket_recognizer(
            # host="www.funasr.com",
            host="localhost",
            port="10096", is_ssl=True, mode="2pass", chunk_size="5,10,5",
            chunk_interval=10, wav_name='microphone'
        )
        self.reference_text = ""
        self.current_text = ""
    ...
    def process_tts(self,quit_event):        
        while not quit_event.is_set():
            try:
                ...
                continue
            self.reference_text = msg
            self.txt_to_audio(msg)
            print("reference_text:::", self.reference_text)
            print("reference_text:::", self.reference_text)
            print("reference_text:::", self.reference_text)
